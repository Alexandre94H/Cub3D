...
/*   Updated: 2020/10/11 18:49:05 by ahallain         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	s(t_runtime *runtime)
{
	...
	next = (t_position) {runtime->player.position.x - 3 * sin(runtime->player.degree * M_PI / 180) / MAX_FPS, runtime->player.position.y + 3 * cos(runtime->player.degree * M_PI / 180) / MAX_FPS};

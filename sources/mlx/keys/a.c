...
/*   Updated: 2020/10/06 21:50:23 by ahallain         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	a(t_runtime *runtime)
{
	...
	next = (t_position) {runtime->player.position.x - 2 * cos(runtime->player.degree * M_PI / 180) / MAX_FPS, runtime->player.position.y - 2 * sin(runtime->player.degree * M_PI / 180) / MAX_FPS};
